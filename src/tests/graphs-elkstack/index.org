...
ELK stack:
 The ELK Stack is a collection of three open-source products Å\ Elasticsearch,
 Logstash, and Kibana Å\ from Elastic. Elasticsearch is a NoSQL database that is
